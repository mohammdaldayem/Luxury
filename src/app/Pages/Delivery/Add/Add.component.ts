...
export class Addomponent {
  ...
  constructor(private _deliveryService: DeliveryService) {
    ...
    this.deliveryValueFormControl = new FormControl('', [
      Validators.required,
    ]);
  ...
  Add() {
    ...
    this._deliveryService.Add({ value: this.deliveryValueFormControl.value }).subscribe(result => {
